...
interface WuzaProjectRoute {
  link?: string
  template?: Type<any> | null
}

interface WuzaProject extends WuzaProjectRoute{
  title: string
  time: string
  content: string
}
...
export class ProjectsService {
  readonly projects: WuzaProject[] = [
    {
      template: null, link: 'sa', title: 'Dafny Language Server', time: 'Sep. bis Dez. 2019',
    ...
    {
      template: null, link: 'antenne', title: 'Newsfeed Antenne Märstetten', time: 'Juni 2019',
      content: 'Mittels React wurde ein Newsticker für die Bewohner von Märstetten implementiert.'
    },

    {
      template: null, link: 'easymech',
      title: 'EasyMech',
    ...
    {
      template: null, link: 'rock_the_ring',
      title: 'Rock the Ring',
    ...
    {
      template: null, link: 'teso-addons',
      title: 'TESO Add-ons',
      time: 'Februar 2017',
    ...
    {
      template: null, link: 'wordpress', title: 'WordPress Sites', time: 'seit Ende 2016',
      content: 'Via BeeBase wurden mehrere Webauftritte von Kunden auf eine moderne Art umgesetzt.'
    },

    {
      template: null, link: 'teso-map',
      title: 'TESO Map',
      time: 'Dezember 2016',
    ...
    {
      template: null, link: 'ipa', title: 'Meine IPA', time: 'März 2015',
    ...
    {
      template: null, link: 'build-tool', time: 'Oktober 2014 bis Januar 2015',
  ...
  get routes(): WuzaProjectRoute[] {
    return this.projects.filter((p) => p.template && p.link)
  }
}
